...
void ripemd160_update(ripemd160_state* S, const unsigned char* data, size_t len);
...
uint32_t static inline f2(uint32_t x, uint32_t y, uint32_t z) { return (x & y) | (~x & z); }
...
static void inline ripemd160_round(uint32_t* a, uint32_t b, uint32_t* c, uint32_t d, uint32_t e, uint32_t f, uint32_t x,
                                   uint32_t k, int r) {
    *a = rol(*a + f + x + k, r) + e;
    *c = rol(*c, 10);
}

static void inline R11(uint32_t* a, uint32_t b, uint32_t* c, uint32_t d, uint32_t e, uint32_t x, int r) {
    ripemd160_round(a, b, c, d, e, f1(b, *c, d), x, 0, r);
}
static void inline R21(uint32_t* a, uint32_t b, uint32_t* c, uint32_t d, uint32_t e, uint32_t x, int r) {
    ripemd160_round(a, b, c, d, e, f2(b, *c, d), x, 0x5A827999ul, r);
}
static void inline R31(uint32_t* a, uint32_t b, uint32_t* c, uint32_t d, uint32_t e, uint32_t x, int r) {
    ripemd160_round(a, b, c, d, e, f3(b, *c, d), x, 0x6ED9EBA1ul, r);
}
static void inline R41(uint32_t* a, uint32_t b, uint32_t* c, uint32_t d, uint32_t e, uint32_t x, int r) {
    ripemd160_round(a, b, c, d, e, f4(b, *c, d), x, 0x8F1BBCDCul, r);
}
static void inline R51(uint32_t* a, uint32_t b, uint32_t* c, uint32_t d, uint32_t e, uint32_t x, int r) {
    ripemd160_round(a, b, c, d, e, f5(b, *c, d), x, 0xA953FD4Eul, r);
}

static void inline R12(uint32_t* a, uint32_t b, uint32_t* c, uint32_t d, uint32_t e, uint32_t x, int r) {
    ripemd160_round(a, b, c, d, e, f5(b, *c, d), x, 0x50A28BE6ul, r);
}
static void inline R22(uint32_t* a, uint32_t b, uint32_t* c, uint32_t d, uint32_t e, uint32_t x, int r) {
    ripemd160_round(a, b, c, d, e, f4(b, *c, d), x, 0x5C4DD124ul, r);
}
static void inline R32(uint32_t* a, uint32_t b, uint32_t* c, uint32_t d, uint32_t e, uint32_t x, int r) {
    ripemd160_round(a, b, c, d, e, f3(b, *c, d), x, 0x6D703EF3ul, r);
}
static void inline R42(uint32_t* a, uint32_t b, uint32_t* c, uint32_t d, uint32_t e, uint32_t x, int r) {
    ripemd160_round(a, b, c, d, e, f2(b, *c, d), x, 0x7A6D76E9ul, r);
}
static void inline R52(uint32_t* a, uint32_t b, uint32_t* c, uint32_t d, uint32_t e, uint32_t x, int r) {
    ripemd160_round(a, b, c, d, e, f1(b, *c, d), x, 0, r);
}
