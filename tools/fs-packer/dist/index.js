...
function appendToStream(data, stream) {
    return new Promise(function (resolve, reject) {
        var canContinue = stream.write(data);
        if (canContinue) {
            resolve();
        }
        else {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, appendToStream(content, stream)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, appendToStream(buffer, stream)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function doPack() {
    return __awaiter(this, void 0, void 0, function () {
        var outfile, stream, files, n, i, file, input, _i, _a, file;
